...
def create_pipeline(create_default_locations=False, shared_path=None, api_username=None, api_key=None):
    ...
    try:
        response = requests.post(url, json=pipeline, auth=ApiKeyAuth())
