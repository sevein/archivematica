...
-- Make the MediaConch command the verification command of the to-mkv
-- normalization command.

UPDATE fpr_fpcommand
    SET verification_command_id = '172b7d5e-abfd-4f99-8345-922dcb53f1af'
    WHERE description = 'Transcoding to mkv with ffmpeg';
